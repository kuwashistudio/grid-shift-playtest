...
assert(Math.abs(initial.x-157)<.1&&Math.abs(initial.y-508)<.1,'bad initial position');
...
assert(mid.y<360,'car did not move forward out of bay');
assert(mid.heading>-1.42,'car did not visibly begin steering');
