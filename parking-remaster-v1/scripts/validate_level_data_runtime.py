...
def main():
    ...
    require('level.vehicles.map' in html, 'runtime does not consume level vehicle data')
    require('level.board.movement_bounds' in html, 'runtime does not consume movement bounds')
    require('level.board.corridor_inset' in html, 'runtime does not consume corridor inset')
    ...
    print('PASS LDP-2: canonical JSON -> generated local JS -> runtime; no hard-coded defs/fetch')
    return 0
