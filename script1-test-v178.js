/* GRID SHIFT v1.7.8 test-only platform adapter.
   Uses a separate localStorage namespace so consolidation QA cannot alter the
   stable v1.7.7 run history or scores. */
(function(){
  'use strict';
  const prefix='gridshift_test_v178_';
  let ready=false;
